...
export const experiences = [
  ...
  },
  {
    ...
    type: 'Internship',
    summary:
      'Worked on geospatial analysis, data management, GIS development, mapping workflows, and Python-based process automation.',
    ...
    projects: [
      {
        ...
        achievements: [
          'Worked in geospatial analysis and data management using C# and .NET.',
          'Used Python for process automation.',
          'Contributed to solutions for mapping jobs with a focus on GIS development.',
          'Used vector mapping tools including Bentley MicroStation.',
        ],
