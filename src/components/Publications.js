  ...
  return `
    <article class="publication-card reveal" style="--delay:${index}">
      <div class="publication-card__visual" aria-hidden="true">
        <div class="paper-visual paper-visual--${index + 1}">
          <div class="paper-visual__top"><span>${publication.year}</span>${icon(index === 0 ? 'fileText' : 'code', { size: 20 })}</div>
          <i></i><i></i><i></i>
          <div class="paper-visual__diagram"><b></b><span></span><b></b></div>
        </div>
      </div>
